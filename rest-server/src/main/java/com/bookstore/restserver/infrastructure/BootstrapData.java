...
import com.bookstore.restserver.domain.BookBuilder;
    ...
    public void populateRepositories() {
        ...
        try {
            ...
            bookRepository.saveBook(
                    new BookBuilder()
                            .setId("3017700001")
                            .setTitle("An Introduction to Algorithms")
                            ...
                            .setPrice(0.20f)
                            .setImageFileName(API_URL + IMAGE_LOCATION + "Algorthims.jpg")
                            .addAuthor(wright)
                            .setPublished(dateFormat.parse("04-01-2014"))
            ...
            bookRepository.saveBook(
                    new BookBuilder()
                            ...
                            .setDescription(".the fundamental computer organization book, both as an int\"roduction for readers with no experience in computer architecture topics, and as an up-to-date reference for computer architects.\"--Computing Reviews, July 22 2014")
                            .setPrice(0.20f)
                            .setImageFileName(API_URL + IMAGE_LOCATION + "CompArch.jpg")
                            .addAuthor(knight)
            ...
            bookRepository.saveBook(
                    new BookBuilder()
                            .setId("3198000001")
                            .setTitle("Learn You a Haskell for Great Good!: A Beginner's Guide")
                            .setDescription("Don't be ashamed if you can't blikkel any more. It's because you couldn't help framishing.")
                            .setPrice(0.20f)
                            .setImageFileName(API_URL + IMAGE_LOCATION + "LearnHaskell.jpg")
                            .addAuthor(janis)
